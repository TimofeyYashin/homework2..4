...
public class Validator {
    ...
    public static void validateLogin(String login) {
        ...
        if (login.length() > MAX_LENGTH) {
            throw new WrongLoginException("Длина логина превышает максимум. Максимальная длина = " + MAX_LENGTH);
        }
    }
    ...
    public static void validatePassword(String password, String confirmPassword) {
        ...
        if (password.length() > MAX_LENGTH) {
            throw new WrongPasswordException("Длина пароля превышает максимум. Максимальная длина = " + MAX_LENGTH);
        }
